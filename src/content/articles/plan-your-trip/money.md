...
These numbers genuinely move, so read the on-screen notice rather than trusting any guide's figure (including this one). For more on avoiding ATM and exchange scams — skimming devices, "help" at the machine, and dodgy kiosks — see [staying safe in Belgrade](/plan-your-trip/staying-safe).
...
There's no single authoritative price index to quote, and any specific figures would date quickly — so think in ranges rather than fixed amounts. In general, Belgrade is relatively affordable compared with Western Europe. Reasonably priced food helps, and free public transport keeps daily costs down; you can read more about that under [getting around Belgrade](/plan-your-trip/getting-around). Budget travellers can manage on a modest daily spend.
