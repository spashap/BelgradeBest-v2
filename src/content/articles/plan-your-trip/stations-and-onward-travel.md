---
leg: "plan-your-trip"
slug: "stations-and-onward-travel"
title: "Belgrade's stations and onward travel"
shortTitle: "Stations & onward travel"
description: "The Belgrade train station moved: rail now runs from Beograd Centar (Prokop), not the old riverside station. Where the main train and bus (BAS) stations are now, and onward travel from Belgrade to Novi Sad, Niš and beyond."
...
faqs:
  ...
  - answer: "Beograd Centar (\"Prokop\") and Beograd Centar railway station are the same place — \"Prokop\" is the everyday name for the area where the station sits, a few kilometres south of the old town. It is the city's de facto main railway station and replaced the historic riverside station that closed in 2018."
    question: "Is Prokop the same as Beograd Centar?"
  - answer: "Prokop is served by bus line 36 (a circular route linking it to the old-town area, Slavija and Savski Trg, roughly every 20 minutes), plus lines 34, 38A, 40, 41 and 44, and by BG Voz suburban trains — all free under the city's transport policy. Bus 600 from the airport is reported to serve Prokop directly. A taxi from the old-town edge takes roughly 10–15 minutes."
    question: "How do I get to Prokop railway station?"
  - answer: "Yes. You can reach Niš from Belgrade by intercity bus from the Block 42 station and by conventional rail from Beograd Centar. As of 2026 the Belgrade–Niš high-speed line is still in planning (targeted around 2027), so the train is the slower, scenic option for now. Confirm timetables and fares close to your travel date."
    question: "Can I get from Belgrade to Niš?"
isFaqCandidate: true
unknowns: []
---
