---
leg: "plan-your-trip"
slug: "taxis-in-belgrade"
title: "Taxis in Belgrade: apps, fares and avoiding scams"
shortTitle: "Taxis"
description: "Taxis in Belgrade in 2026: which apps work (CarGo and Yandex Go — not Uber or Bolt), the fixed-price airport voucher, meters, tariffs and tipping."
lede: "Belgrade taxis are cheap by European standards and mostly fine to use — the real risk isn't your safety, it's being overcharged. The fix is simple and hasn't changed in years: order through an app or by phone, insist on the meter, and never get into an unmarked car at the airport or outside a tourist sight. Here's exactly how taxis work in Belgrade, the apps that actually operate here, and how to dodge the one scam that catches visitors."
heroLabel: "Taxis in Belgrade / hero"
heroAlt: "A licensed taxi on a Belgrade street"
...
faqs:
  - answer: "No — neither Uber nor Bolt operates in Belgrade as of 2026. The apps that do work are CarGo and Yandex Go, both of which let you order a car, see the route, and pay by card, much like Uber elsewhere. If a guide tells you to open Uber or Bolt in Belgrade, it's out of date; install CarGo or Yandex Go instead."
    question: "Does Uber or Bolt work in Belgrade?"
  - answer: "Use the airport's official fixed-price taxi system rather than accepting an offer from anyone who approaches you in the terminal. Belgrade Nikola Tesla Airport has e-kiosks (in baggage reclaim and the arrivals lounge) that print a voucher with a set price to your destination zone, so the fare is agreed before you ride. Booking a CarGo or Yandex Go car from the app works too. The people who get overcharged are almost always the ones who follow a tout to an unmarked car."
    question: "How do I avoid being overcharged by a taxi at Belgrade airport?"
  - answer: "Yes — a legitimate Belgrade taxi runs a meter, and you should insist on it. Fares are city-regulated: a daytime tariff applies on weekdays, with a higher night, Sunday and holiday tariff. Agreeing a flat price without the meter is not recommended, especially at the airport, because that's where padding happens. If a driver won't start the meter, get a different cab."
    question: "Do Belgrade taxis use a meter?"
  - answer: "Often not much, and you don't really need them to. English is hit-or-miss with Belgrade taxi drivers, which is exactly why ordering through CarGo or Yandex Go is easier — you set the destination in the app, so there's no address to explain and the price is shown up front. If you flag a cab on the street, have your destination written down or pinned on a map."
    question: "Do Belgrade taxi drivers speak English?"
  - answer: "By European standards, yes — taxis are relatively inexpensive. Older figures cited a starting fare around 320 RSD and roughly 105 RSD per kilometre on the day tariff; treat those as indicative, as they shift over time. App pricing from CarGo or Yandex Go is comparable and shown before you confirm. The thing that makes a Belgrade taxi 'expensive' is almost always overcharging, not the official rate."
    question: "Are taxis in Belgrade expensive?"
  - answer: "It can be at rush hour. Belgrade has genuine weekday congestion, especially on the bridges across the Sava between the old centre and New Belgrade, roughly 8–9am and 4–7pm. Because a metered fare keeps ticking in stopped traffic, an app that quotes an upfront price can save you money at busy times — and for short central hops, the free buses and trams or simply walking are often faster than sitting in a cab."
    question: "Is Belgrade traffic bad, and does it affect taxi fares?"
isFaqCandidate: true
unknowns: []
---
...
For the full set of airport options — including the much cheaper free city bus — see our [airport-to-city guide](/plan-your-trip/airport-to-city).
...
For short hops in the centre, remember the alternative: Belgrade's buses, trams and trolleybuses have been **free for everyone since 2025**, and the core is walkable, so you often don't need a taxi at all. Our [getting-around guide](/plan-your-trip/getting-around) covers when each option wins.
