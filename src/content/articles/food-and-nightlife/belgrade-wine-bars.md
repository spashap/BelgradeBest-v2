...
Rakija's most traditional home, though, is the kafana, where it arrives with toasts and slow conversation rather than a tasting menu. If that's the version of the ritual you want, [Belgrade's kafanas](/food-and-nightlife/belgrade-kafanas) are the natural setting, and that page covers the experience properly.
