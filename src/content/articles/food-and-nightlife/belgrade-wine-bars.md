...
**IL Grappolo**, on **Obilićev venac** in the city centre — the cluster of cafe-lined passages just off the [Knez Mihailova](/glossary/knez-mihailova) pedestrian spine, a few minutes' walk from Republic Square — is a wine bar with a broad domestic and foreign selection representing all of Serbia's wine regions, alongside brandies and craft beer. It has been operating at least since 2018, which by the standards of this scene counts as settled. **Proces Wine Bar** is the other regular fixture, focused on Serbian wines — including amber and skin-contact labels — with knowledgeable staff and a social atmosphere. It is consistently cited by wine media, though still relatively young.
...
Rakija's most traditional home, though, is the [kafana](/glossary/kafana), where it arrives with toasts and slow conversation rather than a tasting menu. If that's the version of the ritual you want, [Belgrade's kafanas](/food-and-nightlife/belgrade-kafanas) are the natural setting, and that page covers the experience properly.

## Where this fits in a Belgrade night

Wine bars and rakija tasting are a distinct, lower-key going-out mode. This is sit-and-taste rather than club — an evening built around what's in the glass and the people you're with, overlapping at one end with the kafana world (rakija) and at the other with fine dining (wine). It's a good counterweight to the [splav](/glossary/splav) and club scene, and an easy way to spend an evening if loud nights aren't what you're after. For more ways to fill the rest of a day or evening, [things to do in Belgrade](/visit-belgrade/things-to-do-in-belgrade) is a useful starting point.
