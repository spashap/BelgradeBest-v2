...
description: "Where to eat and drink in Belgrade by neighborhood: the city's eating-and-drinking character district by district — Skadarlija's kafanas, Dorćol's coffee and craft beer, Savamala's river clubs, Cetinjska, Beton Hala, Zemun, Vračar and New Belgrade."
...
A few things to set expectations. The historic Skadarlija kafanas are heavily touristed, with multilingual menus and live music nightly, and they are priced above neighbourhood averages — treat an evening here as a special experience rather than everyday dining. Some visitors are surprised by music charges or higher prices on live-music nights, so it's worth checking. A full kafana meal for two (shared starters, grilled meat, sides, dessert and drinks) at a mid-range central kafana commonly landed around 4,000–8,000 RSD as of 2024–2025 — upper mid-range for local dining, and a perishable figure to treat as indicative only.

If you want one evening that feels unmistakably old-Belgrade, this is where it happens. For the full picture of what a kafana is, which institutions are durable, and how to approach an evening there, see the guide to [Belgrade kafanas](/food-and-nightlife/belgrade-kafanas).
...
**Where it sits:** Beton Hala is on the Sava waterfront below Kalemegdan, a short distance from Savamala along the riverbank — a converted industrial warehouse strip right on the quay.

Beton Hala offers a more refined register than the splavovi a little upriver. Set in a converted warehouse, it is a polished **dining-and-drinks strip** of Serbian and international restaurants with river views, cocktail bars, and venues designed to blend dinner into a late night — many show hours running from late morning to around 04:00, which captures how eating and nightlife merge here. Cuisines span Italian (shared-plates places like the long-popular, Michelin-listed Comunale), seafood, steak and fusion, alongside cocktail lounges. The crowd is dressier and a touch older than Savamala — better-dressed, higher prices, locals in their late twenties to forties.

Where Savamala is loose and club-driven, Beton Hala is dinner-led and cocktail-friendly — a good choice if you want river-view eating and cocktails in one place, easing from the table into the evening without changing district. For the restaurants by name, see [best restaurants in Belgrade](/food-and-nightlife/best-restaurants-in-belgrade); for the cocktail-bar side, [Belgrade nightlife](/food-and-nightlife/belgrade-nightlife).
