...
shortTitle: "IVF explained"
description: "IVF explained: a clinical, law-free guide to in vitro fertilisation — the stages of an IVF cycle and timeline, IUI vs IVF, donor-egg vs own-egg IVF, what really affects success rates, the add-ons that raise the real cost, and the international price landscape. Serbian eligibility and law are handled separately."
lede: "IVF explained, plainly: in vitro fertilisation retrieves eggs, fertilises them in a lab and transfers the resulting embryos — and a single cycle often isn't enough. Here's the educational explainer: the stages of a cycle and how long it takes, how IVF differs from IUI, how donor-egg cycles differ from using your own eggs, why success is strongly age-dependent and lower than headline figures, and what the headline price leaves out — the process, not the law. This informs; it is not medical advice."
heroLabel: "IVF explained / hero"
heroAlt: "A calm embryology lab bench with a microscope and culture dishes"
...
faqs:
  - answer: "An IVF cycle moves through several distinct stages: ovarian stimulation with hormone medication, with monitoring (scans and bloodwork) to track how the ovaries respond; a trigger injection to mature the eggs; egg retrieval under sedation; fertilisation in the lab by conventional IVF or by ICSI, where a single sperm is injected into an egg; embryo culture over several days, sometimes to the blastocyst stage; embryo transfer into the uterus; and then a waiting period, often around two weeks, before a pregnancy test. A frozen embryo transfer (FET) uses previously vitrified embryos thawed in a later cycle, so it is a separate procedure from the original retrieval."
    question: "What are the stages of an IVF cycle?"
  - answer: "The clinical steps are broadly the same — stimulation or cycle preparation, fertilisation in the lab, culture and transfer — but the egg source differs. In an own-egg cycle the patient is stimulated and her own eggs are retrieved, and success falls significantly with her age because egg quality and quantity decline over time. In a donor-egg cycle the eggs come from another person, so success tends to track the donor's age and characteristics rather than the recipient's, which is why donor-egg outcomes are often reported differently from own-egg outcomes. Who is eligible for donor treatment, and the rules around donation, are legal questions that vary by country and are not covered here — see the Belgrade IVF page for the Serbian framework."
    question: "How does donor-egg IVF differ from using your own eggs?"
  - answer: "The single biggest factor is the woman's age when using her own eggs, because egg quality and quantity decline over time; success drops markedly at older ages. The underlying cause of infertility, ovarian reserve, sperm quality, embryo quality, whether genetically tested embryos are transferred, the uterine environment, body weight, smoking and the number of cycles attempted all play a part as well. Because of this, a meaningful per-cycle figure is one banded by age and cause — a single headline number averaged across all patients tells you little about your own situation (indicative framing, as of 2026)."
    question: "What factors affect IVF success rates?"
  - answer: "A cycle involves ovarian stimulation with hormone medication and monitoring, egg retrieval under sedation, fertilisation in the lab by conventional IVF or ICSI, embryo culture over several days, embryo transfer, and a wait before a pregnancy test. A frozen embryo transfer uses previously vitrified embryos in a later cycle."
    question: "What does a single IVF cycle involve?"
  - answer: "They are different treatments. IUI (intrauterine insemination) places prepared sperm directly into the uterus around ovulation, with no egg retrieval and no laboratory fertilisation; it is simpler, lower-cost and lower-success-per-attempt. IVF retrieves eggs, fertilises them in the lab and transfers resulting embryos — more involved and more expensive, but generally with higher success per attempt and able to address more causes of infertility, including via ICSI. Which is appropriate depends on the cause and is a question for a fertility specialist, not a brochure."
    question: "What is the difference between IUI and IVF?"
  - answer: "Often not — a single cycle is frequently unsuccessful and multiple cycles are common. Success declines significantly with the woman's age when using her own eggs, so planning for a single attempt tends to set up disappointment."
    question: "Is one IVF cycle usually enough?"
  - answer: "A quoted rate changes depending on what it measures — per-cycle started versus per-transfer, or clinical pregnancy versus live birth — and on the age mix of the patients counted. A per-transfer, clinical-pregnancy figure will look higher than a per-cycle, live-birth figure even at the same clinic. Because of this, rates are often not comparable across clinics and should be read carefully for exactly what they count."
    question: "Why do clinics' success rates differ so much?"
  - answer: "Headline prices rarely include medication, ICSI, PGT, vitrification and storage, or separate embryo-transfer and FET fees, all of which can substantially raise the real cost. The realistic all-in total can be considerably higher than the advertised figure, and some add-ons have limited evidence of improving live-birth rates for general patients."
    question: "What does the headline IVF price leave out?"
  - answer: "As of 2026, a single cycle before add-ons ranges roughly €1,800–€5,200 across popular destinations, with Western markets such as the UK, Germany, Australia and the US generally higher and lower-cost European hubs below that. These figures are indicative and perishable, and the all-in cost after medication and add-ons is typically higher."
    question: "How much does an IVF cycle cost internationally?"
isFaqCandidate: true
unknowns: []
---
...
The headline figure, though, is the wrong number to plan around. Package prices commonly exclude medication, PGT, vitrification, storage and separate transfer fees — so the realistic all-in total can be considerably higher than the advertised price, and an FET in a later month is a further separate cost. For how this plays out alongside other procedures, our overview of [medical tourism costs in Belgrade](/medical-tourism/medical-tourism-costs-in-belgrade) is a useful companion, and our guidance on [risks and aftercare](/medical-tourism/medical-tourism-risks-and-aftercare) is worth reading before you travel for any treatment. Belgrade and Serbia prices specifically — along with the legal eligibility picture and donation rules — live on the dedicated [IVF and fertility in Belgrade](/medical-tourism/ivf-and-fertility-belgrade) page rather than here.
...
If you're combining a consultation with time in the city, our guide to [things to do in Belgrade](/visit-belgrade/things-to-do-in-belgrade) covers the rest of the trip. The clinical decision, though, should rest on realistic expectations: this is a process, often a repeated one, with success that depends heavily on age and on factors no brochure can promise away.
