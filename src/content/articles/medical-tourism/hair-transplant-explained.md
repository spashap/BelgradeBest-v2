---
leg: "medical-tourism"
slug: "hair-transplant-explained"
title: "Hair transplants explained — FUE, FUT and realistic results"
shortTitle: "Hair transplants explained"
description: "Hair transplants explained: FUE vs FUT vs DHI, how grafts are counted and priced, the recovery timeline, and what one session can realistically give."
lede: "A hair transplant moves your own follicles from donor areas to thinning ones — it redistributes hair, it doesn't make new hair. Here's the hair transplant explained plainly: FUE versus FUT versus DHI, how grafts are counted and priced, the recovery timeline, and why one session and a before-and-after photo rarely tell the whole story."
heroLabel: "Hair transplants explained / hero"
heroAlt: "A follicle diagram and a hairline-mapping sketch on a clinician's desk"
...
faqs:
  - answer: "Both move individual follicular units, so DHI is best understood as a marketed variant of FUE rather than a wholly different operation. In standard FUE the surgeon creates the recipient incisions first and then places grafts; DHI (direct hair implantation) uses an implanter pen to make the incision and place the graft in one motion, which proponents say allows tighter control of angle and depth. Neither is universally superior — outcomes depend far more on the operator and your case than on the label (indicative, as of 2026; nothing here is medical advice)."
    question: "What's the difference between FUE and DHI?"
  - answer: "Transplanted hairs commonly shed in the first weeks — that shedding is expected, not failure — and then regrow gradually. Many people see early regrowth from around three to four months, more meaningful coverage by roughly six to nine months, and the final result mature at around twelve months, sometimes longer for dense or high-graft cases. Timelines vary by individual, so treat any single before-and-after photo with caution (indicative, as of 2026)."
    question: "How long until transplanted hair grows?"
  - answer: "Clinics usually price per graft (a graft is one follicular unit, typically one to four hairs) or per session, so the graft estimate drives the quote. The number of grafts depends on the area being covered and the degree of loss, and is bounded by your finite donor supply — not by how much you are willing to spend. Be aware graft counting is not perfectly standardised across clinics, headline 'all-inclusive' prices often exclude repeat sessions, medication, PRP and follow-up, and country averages differ widely (Turkey lowest, Western Europe and Australia highest, Serbia mid-price). Confirm exactly what a quoted graft number and price include (indicative, as of 2026)."
    question: "How are graft numbers and price calculated?"
  - answer: "No. A transplant redistributes your own existing donor hair rather than creating new hair, so results are bounded by your donor supply."
    question: "Does a hair transplant create new hair?"
  - answer: "FUE harvests individual follicular units directly and leaves minimal linear scarring; FUT removes a strip of scalp dissected into grafts and can yield many grafts in one session but leaves a linear donor scar; DHI is an implanter-pen variant of FUE. None is universally best — the right choice depends on the case and the operator."
    question: "What is the difference between FUE and FUT?"
  - answer: "A single session may not achieve the density you want, and a second session is common. Native hair can keep thinning around transplanted grafts, so ongoing medication is often advised."
    question: "Will one session be enough?"
  - answer: "Pricing is often per graft or per session and varies widely by country: Turkey is the low-cost leader, Western Europe and Australia are substantially higher, and Serbia sits mid-price (indicative, as of 2026)."
    question: "How much does a hair transplant cost?"
  - answer: "Risks include infection, poor graft survival, unnatural-looking results if poorly planned, and donor-area scarring (linear with FUT). Outcomes are heavily operator- and planning-dependent."
    question: "What are the main risks?"
  - answer: "Final results take many months to mature, and transplanted hair commonly sheds before it regrows, so early appearance is not a reliable indicator."
...
If you're weighing Belgrade specifically, the local price bands and the Serbia-versus-Turkey question are covered in our guide to [hair transplant in Belgrade](/medical-tourism/hair-transplant-belgrade), and the broader picture sits in [medical tourism costs in Belgrade](/medical-tourism/medical-tourism-costs-in-belgrade).
...
If you're already considering a trip to combine treatment with a visit, our overview of [things to do in Belgrade](/visit-belgrade/things-to-do-in-belgrade) is a sensible place to start once the clinical questions are settled.