---
leg: "medical-tourism"
slug: "choosing-a-clinic-in-belgrade"
title: "Choosing a clinic in Belgrade — how to vet a provider"
shortTitle: "Choosing a clinic"
description: "How to choose a clinic in Belgrade: an independent, trust-first method for vetting a medical or dental provider — how to verify a surgeon's licence with Serbia's medical or dental chamber, what accreditation actually means, the questions to ask before booking abroad, and how to tell a genuine review from a fake one."
lede: "Glossy websites and five-star reviews don't tell you whether a clinic is safe. This page hands you an independent way to judge one yourself — how to verify the surgeon's licence, what to ask, what a credible answer looks like, and how to read reviews critically — without naming a 'best' clinic, because that's not how vetting works."
heroLabel: "Choosing a clinic in Belgrade / hero"
heroAlt: "A desk with a clinic brochure, a checklist and a magnifying glass — doing due diligence"
...
faqs:
  - answer: "No. Independent sources warn that glossy websites and five-star reviews do not reliably indicate medical safety standards, and clinic-reported success and complication figures are usually unaudited."
    question: "Can I trust a clinic's website and reviews to judge its safety?"
  - answer: "Treat it as a claim to verify, not a default. Real signals include recognised international accreditation such as JCI, ISO or Temos and national licensing through the Agency for Accreditation of Health Care Institutions of Serbia or the Ministry of Health — verify any claimed accreditation with the issuing body directly."
    question: "What does 'internationally accredited' actually mean for a Belgrade clinic?"
  - answer: "Clinics and facilitators commonly advertise 70–80% savings, but more neutral cost-comparison analysis puts realistic all-in savings nearer 20–60% once travel and extras are included. The neutral comparison is the more credible basis."
    question: "Are the 70–80% savings clinics advertise realistic?"
  - answer: "Get clear written answers on what the price includes and excludes, who performs the procedure and their credentials, infection-control standards, what happens with complications, what aftercare is provided and for how long, whether follow-up is on-site or remote, and what recourse exists if something goes wrong."
    question: "What should I ask a clinic before booking?"
  - answer: "Facilitators can simplify a trip but have a commercial interest in the clinics they place patients with. Independent guidance is to treat their recommendation as a starting point to verify independently, not as impartial advice."
    question: "Can I rely on a medical-tourism facilitator's recommendation?"
  - answer: "Verify the individual, not just the clinic brand. In Serbia, doctors must be registered with the Medical Chamber of Serbia and dentists with the Dental Chamber of Serbia, and the facility itself must be licensed by the Ministry of Health under the Law on Health Care. Ask for the practitioner's full name and chamber/licence number, then confirm it on the relevant chamber's register rather than relying on the website. Cross-check their named specialty and training, and treat any credential that cannot be substantiated as a red flag (indicative posture, as of 2026)."
    question: "How do I verify a Serbian surgeon's license and credentials?"
  - answer: "Get clear written answers, before you pay, on: exactly what the quote includes and excludes (and what each itemised line costs); who will perform the procedure and their credentials; the facility's infection-control and sterilisation standards; what happens if there are complications during or after treatment; what aftercare is provided and for how long; whether follow-up is on-site, remote, or left to your home country; and what recourse exists if the outcome is poor. A credible provider answers plainly and in writing; vagueness, deflection, or pressure to decide quickly are the opposite of a credible answer."
    question: "What questions should I ask a clinic before booking?"
  - answer: "Treat reviews as a signal to test, not proof. Genuine reviews tend to be specific (named procedure, timeline, mixed pros and cons), spread out over time, and posted across independent platforms you don't control. Be sceptical of clusters of five-star reviews posted close together, generic praise with no procedure detail, near-identical phrasing, reviews that only ever appear on the clinic's own site, and incentivised reviews (a discount or freebie in exchange for a rating). Self-reported and curated reviews — like clinic-published success and complication figures — are usually unaudited, so weight independent, detailed, longitudinal feedback over volume of stars (indicative posture, as of 2026)."
    question: "How can I tell a genuine review from a fake one?"
isFaqCandidate: true
unknowns: []
---
...
Vagueness, deflection, or pressure to decide quickly are the opposite of a credible answer. The complications-and-aftercare side of this deserves its own attention; for the full picture, see [medical tourism risks and aftercare](/medical-tourism/medical-tourism-risks-and-aftercare).
...
The savings claim deserves spelling out, because it is a genuine conflict. Clinics and facilitators commonly advertise savings of 70–80%. More neutral cost-comparison analysis puts the realistic all-in saving nearer 20–60% once travel, accommodation and extras are counted. Both figures exist; the neutral comparison is the more credible basis for a decision, and you should treat the marketing number as the ceiling of optimism rather than the expected outcome. No price is settled until it is itemised and confirmed for your case. The detail of where money actually goes belongs on its own page — see [medical tourism costs in Belgrade](/medical-tourism/medical-tourism-costs-in-belgrade).
...
A few related concerns sit on other pages by design. Transport, accommodation and currency belong to other legs of this guide; staying well day to day while you are here is covered under [staying safe and healthy in Belgrade](/plan-your-trip/staying-safe). Use those for context, and keep this page for the one job it does: vetting the provider before you commit.
