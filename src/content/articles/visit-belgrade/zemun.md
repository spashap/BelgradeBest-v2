...
This is why the district is worth a half-day. Belgrade's history comes in layers, and Zemun is the most legible Austro-Hungarian one — the place where the Habsburg-frontier chapter survives as something you can walk through rather than something you have to imagine from a plaque. If you want the wider sense of how these layers stack up across the city, the [understanding Belgrade](/visit-belgrade/understanding-belgrade) page sets out the chronology; for a sense of where Zemun sits among the city's districts, the [neighbourhoods](/visit-belgrade/belgrade-neighborhoods) overview is the place to start.
