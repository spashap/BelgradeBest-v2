...
description: "The best day trips from Belgrade — Novi Sad by train in about 35 minutes, the Iron Gates gorge with Golubac and Lepenski Vir, and Oplenac at Topola."
...
If you want a single rule to carry in your head, here it is. Novi Sad on its own is self-guided-friendly, with a tour entirely optional. Novi Sad combined with Sremski Karlovci and Fruška Gora is tour-preferred. The Iron Gates — Golubac plus Lepenski Vir — is tour-dependent for a single day. And Oplenac at Topola is tour-dependent unless you are driving. That split is the honest backbone of these trips: it tells you where your own two feet and a cheap train ticket are enough, and where a guide and a vehicle genuinely earn their keep.

## A note on prices

Every price and journey time in this article is indicative and perishable. The fares, tour prices, and timetables shift, and the year-stamps above — 2024 for the Iron Gates tour, 2025 for the Novi Sad combination — mark when the figure was last observed, not when this page was written. Treat them as orders of magnitude rather than quotes, and confirm the current numbers when you book.

The one fact worth leaning on is the mechanism, not the money: Novi Sad is a short, frequent, cheap train ride you can do unaided, while the gorge and the mausoleum reward a tour. For ticketing details and onward connections, our guide to [stations and onward travel](/plan-your-trip/stations-and-onward-travel) is the place to start before any of these trips, and it is also where to confirm current train and bus departures once you have settled on a destination.