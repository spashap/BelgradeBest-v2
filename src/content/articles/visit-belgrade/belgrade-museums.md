---
leg: "visit-belgrade"
slug: "belgrade-museums"
title: "Belgrade museums — hours, prices, and which are worth it"
shortTitle: "Museums"
description: "The best museums in Belgrade and where they are — the Tesla Museum, Museum of Yugoslavia, MoCAB, National Museum and more — with district orientation and indicative 2026 hours, prices and free days."
...
faqs:
  - answer: "The core set is the Nikola Tesla Museum, the National Museum of Serbia, the Museum of Contemporary Art (MoCAB), the Museum of Yugoslavia with the House of Flowers, the Military Museum and the Ethnographic Museum. The Historical Museum, Natural History Museum and Museum of Illusions are options rather than essential stops."
    question: "Which Belgrade museums are worth visiting?"
  - answer: "No. As of 2026 the Nikola Tesla Museum is cash only in RSD and does not accept credit cards, so bring cash. Visits are on mandatory ~45-minute guided tours starting hourly in Serbian and English."
    question: "Does the Tesla Museum take card payment?"
  - answer: "As of 2026, MoCAB is free on the first Wednesday of each month, the Museum of Yugoslavia on the first Thursday, the National Museum every Sunday, and the Ethnographic Museum on Mondays (reported). These rules are perishable, so confirm on the official site."
    question: "When can I visit Belgrade museums for free?"
  - answer: "Yes — the honored pattern is closed on Mondays and free on Sundays. One aggregator lists the reverse (closed Sunday, open Monday), but that contradicts the established schedule and is likely wrong."
    question: "Is the National Museum of Serbia closed on Mondays?"
  - answer: "As of 2026 it opens Tuesday to Sunday 10:00–18:00 and closes on Mondays. Full tickets are 800 RSD, with reduced rates for residents, students and pensioners, and free entry on the first Thursday of each month and on 4 and 25 May."
    question: "When is the Museum of Yugoslavia open and how much does it cost?"
isFaqCandidate: true
unknowns: []
---
