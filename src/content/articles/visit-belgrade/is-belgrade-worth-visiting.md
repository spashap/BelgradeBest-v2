...
description: "Is Belgrade worth visiting? An honest yes — it's safe, affordable and walkable, with layered crossroads history. How safe, how cheap and when to go."
...
linksTo:
  ...
  - "/plan-your-trip"
faqs:
  - answer: "Yes, Belgrade is generally safe, with low violent crime; the U.S. State Department links violent crime mainly to organised crime and hooliganism around high-profile sporting events, not tourists. The main visitor risks are pickpocketing in crowds and taxi overcharging."
    question: "Is Belgrade safe for tourists?"
  - answer: "It's affordable but no longer ultra-cheap. As of 2026, a budget day runs around $50, mid-range about $150–170, and comfort or luxury from $250–450 a day, with several major sights and all city public transport free."
    question: "Is Belgrade cheap to visit?"
  - answer: "April to June and September to October offer mild weather and festivals, while July and August can be very hot. In 2027, Expo (15 May–15 August) will intensify summer crowds, so the shoulder months are a better bet if you aren't attending."
    question: "When is the best time to visit Belgrade?"
  - answer: "The currency is the Serbian dinar (RSD) only and euros aren't accepted in shops, but cards are widely accepted and ATMs are common. English proficiency is high, so visitors generally manage in English alone."
    question: "Do I need cash, and will English be enough?"
  - answer: "Yes. Since 1 January 2025, buses, trams and trolleybuses have been free for all passengers."
