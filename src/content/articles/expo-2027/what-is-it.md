...
linksTo:
  - "/visit-belgrade"
faqs:
  - answer: "The official theme of Expo 2027 Belgrade is \"Play for Humanity: Sport and Music for All.\" It treats play — through sport, music, games and creative expression — as a catalyst for learning, innovation, social connection and global cooperation, presented across three thematic pavilions and a Forum."
    question: "What is the theme of Expo 2027?"
  - answer: "Yes. Expo 2027 Belgrade is the first Specialised Expo ever held in the Western Balkans, recognised by the Bureau International des Expositions (BIE) following Serbia's election as host and approval of its Recognition Dossier."
    question: "Is Expo 2027 the first expo in the Balkans?"
  - answer: "The organiser has outlined a legacy plan, reported (not yet a binding schedule): the international participants' area is meant to become a new Belgrade Fair, the National Stadium in Surčin remains the anchor, and modular pavilions are to be dismantled and repurposed as schools, kindergartens and sports halls across Serbia. The new Expo director has called it the first Expo \"completely focused on legacy.\" As of June 2026 there is no legally binding delivery timeline."
    question: "What happens to the Expo site after 2027?"
  - answer: "A Specialised Expo is a BIE-recognised exposition that lasts three months and focuses on a specific theme, rather than the broader, larger scope of a Universal (World) Expo. Expo 2027 Belgrade is the first Specialised Expo in the Western Balkans."
    question: "What is a Specialised Expo?"
  - answer: "It runs from 15 May to 15 August 2027 — 93 days. The main site is in Surčin, in western Belgrade, about 13.5 km from downtown and about 5 km from Nikola Tesla International Airport."
  ...
  - answer: "As of June 2026 the official Participants page lists 137 committed nations — a figure that has grown over time (a July 2025 release reported 117) and may change. The official Participants FAQ projects around 4.1 million visits over the 93 days, but this is a projection, not a count."
  ...
  - answer: "Not yet. As of June 2026, only high-level programme categories are described; no full daily calendar of concerts, sports events, conferences or ceremonies has been published."
    question: "Is the full event programme published?"
isFaqCandidate: true
unknowns: []
---
...
**On planning the trip itself:** because demand will be concentrated into one summer, it's worth thinking early about timing and a base. Our [Visit Belgrade](/visit-belgrade) overview is the place to start on the city itself, and the wider [Expo 2027 visitor guide](/expo-2027/guide) pulls the practical pieces together.
